...
load("./lab_plus_clin.rda")  # source("./lab_plus_clin model.R")
...
Barplot_data$group = "21 biomarkers"
Barplot_data_t$group = "21 biomarkers + clinical factors"
...
ggplot(my_data,aes(x = Predictor, y = AUC,
  ...
  # geom_jitter(color="black", size=0.4, alpha=0.9) +
  # geom_hline(yintercept=0.75, color="darkgrey", linetype="dashed")+
  ggtitle("AUC value of each models") + stat_compare_means(method = "anova") # wilcox.test


ggsave("21 vs 21+clin.pdf",width = 16.2,height = 10)